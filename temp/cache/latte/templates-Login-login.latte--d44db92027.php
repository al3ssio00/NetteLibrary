...
/** source: /home/alessio/sviluppo/nette-blog/app/Presenters/LoginModule/templates/Login/login.latte */
final class Template_d44db92027 extends Latte\Runtime\Template
{
	public const Source = '/home/alessio/sviluppo/nette-blog/app/Presenters/LoginModule/templates/Login/login.latte';
...
';
        ...
        <button';
		echo ($ʟ_elem = Nette\Bridges\FormsLatte\Runtime::item('submit', $this->global)->getControlPart())->addAttributes(['data-mdb-button-init' => null, 'data-mdb-ripple-init' => null, 'class' => null, 'type' => null])->attributes() /* line 19 */;
		echo ' data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5" type="submit">Login</button>
    ';
...
';
    ...
    <div>
        ...
        <a href="registrazione" class="text-white-50 fw-bold">Sign-Up</a>
    </div>
';
	}
}
